...
# Arguments
- `secondorder_cutoff::Float64`: Cutoff for the second order force constants.
- `thirdorder_cutoff::Float64 = -1.0`: Cutoff for the third order force constants.
- `fourthorder_cutoff::Float64 = -1.0`: Cutoff for the fourth order force constants.
...
- `temperature::Float64 = -1.0`: Temperature for the self-consistent solver.
...
Base.@kwdef struct ExtractForceConstants <: TDEP_Command
    secondorder_cutoff::Float64
    thirdorder_cutoff::Float64 = -1.0
    fourthorder_cutoff::Float64 = -1.0
    polar::Bool = false
    stride::Int = 1
