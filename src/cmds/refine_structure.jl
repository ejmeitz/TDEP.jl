...
# Arguments
- `tolerance_lattice::T = 1e-5`: Tolerance for the lattice symmetry.
- `tolerance_internal::T = 1e-5`: Tolerance for internal atomic degrees of freedom.
...
"""
Base.@kwdef struct RefineStructure{T} <: TDEP_Command{T}
    tolerance_lattice::T = 1e-5
    tolerance_internal::T = 1e-5
